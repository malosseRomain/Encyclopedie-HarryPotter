...
import {
  ...
  msgErrorData,
  msgErrorSearch
} from '../controllers/sortsController'; //variable
...
import {
  ...
  previousPage,
  goToPage
} from '../controllers/sortsController'; //function
...
<template>
  ...
  <section v-else>
    ...
    <ul>
      <sortComponent v-for="item in list" :key="item.id" :itemProps="item" :msg="item" :defaultImageURL="defaultImageURL" />
    </ul>
