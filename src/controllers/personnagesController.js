import { ref } from 'vue'
import { getPersonnages } from "../model/communicationAPI";
import { scrollToTop } from "../utils/actionWindow";

const itemsPerPage = 16;
const totalItems = 4675; //valeur fixe récupéré sur le site web de l'API
...
export const fetchData = async () => {
    try {
        ...
        list.value = await getPersonnages(`?page[size]=${itemsPerPage}&page[number]=${pageNumber.value}${filter}`);
        scrollToTop();
